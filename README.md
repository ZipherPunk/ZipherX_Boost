...
|---------|-------|-------------|
| **Shielded Outputs** | 1,044,716 | Encrypted notes for trial decryption |
| **Shielded Spends** | 434,027 | Nullifiers for spent note detection |
| **Block Hashes** | 2,496,651 | For P2P header validation (Sapling onwards) |
| **Block Timestamps** | 2,496,651 | For transaction date display |
...
[Hashes Data: 2,496,651 × 32 = ~76.2 MB]
[Timestamps Data: 2,496,651 × 4 = ~9.5 MB]
[Tree Data: 478 bytes]
...
|---------|--------------|------------|-------|
| Outputs | 476,969 | 2,973,619 | From Sapling activation |
| Spends | 476,969 | 2,973,619 | From Sapling activation |
| Hashes | 476,969 | 2,973,619 | From Sapling (no pre-Sapling hashes) |
| Timestamps | 476,969 | 2,973,619 | From Sapling activation |
| Tree | 476,969 | 2,973,619 | Sapling commitment tree |
...
# Expected: 8b1cef117557eb53e98d6425f122143d55a5fe794f919f313abb61fec090c0d6
```
...
| Chain Height | 2,973,619 |
| Block Hash | `000001a42083f5a6f2d89bc16bd65d2022b6ffb22fa924463449cfe7a693b0b9` |
| Tree Root | `682eda0246512d81b13e1f20029253d8a77b173d4a38d5ae30777e3bcb775898` |
...
| Metric | Value |
|--------|-------|
| Generation Speed | 2,013 blocks/sec |
| Total Blocks Scanned | 2,496,651 |
| Generation Time | 20.7 minutes |
