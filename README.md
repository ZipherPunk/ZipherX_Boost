...
|---------|-------|-------------|
| **Shielded Outputs** | 1,044,150 | Encrypted notes for trial decryption |
| **Shielded Spends** | 433,458 | Nullifiers for spent note detection |
| **Block Hashes** | 2,487,160 | For P2P header validation (Sapling onwards) |
| **Block Timestamps** | 2,487,160 | For transaction date display |
...
[Hashes Data: 2,487,160 × 32 = ~75.9 MB]
[Timestamps Data: 2,487,160 × 4 = ~9.5 MB]
[Tree Data: 478 bytes]
...
|---------|--------------|------------|-------|
| Outputs | 476,969 | 2,964,128 | From Sapling activation |
| Spends | 476,969 | 2,964,128 | From Sapling activation |
| Hashes | 476,969 | 2,964,128 | From Sapling (no pre-Sapling hashes) |
| Timestamps | 476,969 | 2,964,128 | From Sapling activation |
| Tree | 476,969 | 2,964,128 | Sapling commitment tree |
...
# Expected: acae62c37d09f39719ae9a5f19a4c2c75f6017a342f883744062b9d87af65e88
```
...
| Metric | Value |
|--------|-------|
| Generation Speed | 1,830 blocks/sec |
| Total Blocks Scanned | 2,487,160 |
| Generation Time | 22.6 minutes |
